            ...
            <aside className="ct-info">
              ...
              <div className="ct-info-body">
                ...
                <a href="tel:+918975091999" className="ct-wa-btn">
                  ...
                  Call Sales
                  <svg viewBox="0 0 16 16" fill="none" stroke="rgba(14,28,47,0.5)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" width="14" height="14" style={{ marginLeft: "auto" }}>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="ct-brochure-hint">
                    <span className="ct-brochure-hint-icon">
                      <svg viewBox="0 0 24 24" fill="none" stroke="#e8a020" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="18" height="18">
                    ...
                    {sending ? (
                      ...
                      <>
                        ...
                        <span className="ct-submit-arrow">
                          <svg viewBox="0 0 16 16" fill="none" stroke="#0e1c2f" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="12" height="12">
                            <path d="M3 8h10M9 4l4 4-4 4" />
                          </svg>
                        </span>
                      </>
